...
Error: Undefined variable: "$input-height".
        on line 7 of C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\form\select.sass
...
Backtrace:
C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\form\select.sass:7
...
body:before {
  ...
  content: "Error: Undefined variable: \"$input-height\".\A         on line 7 of C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\form\select.sass\A \A 2:   display: inline-block\A 3:   max-width: 100%\A 4:   position: relative\A 5:   vertical-align: top\A 6:   &:not(.is-multiple)\A 7:     height: $input-height\A 8:   &:not(.is-multiple):not(.is-loading)\A 9:     &::after\A 10:       @extend %arrow\A 11:       border-color: $input-arrow\A 12:       right: 1.125em"; }
