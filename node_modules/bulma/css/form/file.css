...
Backtrace:
C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\form\file.sass:1
...
body:before {
  ...
  content: "Error: Undefined variable: \"$border\".\A         on line 1 of C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\form\file.sass\A \A 1: $file-border-color: $border !default\A 2: $file-radius: $radius !default\A 3: \A 4: $file-cta-background-color: $scheme-main-ter !default\A 5: $file-cta-color: $text !default\A 6: $file-cta-hover-color: $text-strong !default"; }
