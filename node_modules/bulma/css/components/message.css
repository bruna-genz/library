...
Backtrace:
C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\components\message.sass:1
...
body:before {
  ...
  content: "Error: Undefined variable: \"$background\".\A         on line 1 of C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\components\message.sass\A \A 1: $message-background-color: $background !default\A 2: $message-radius: $radius !default\A 3: \A 4: $message-header-background-color: $text !default\A 5: $message-header-color: $text-invert !default\A 6: $message-header-weight: $weight-bold !default"; }
