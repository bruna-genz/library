...
Backtrace:
C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\components\list.sass:1
...
body:before {
  ...
  content: "Error: Undefined variable: \"$scheme-main\".\A         on line 1 of C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\components\list.sass\A \A 1: $list-background-color: $scheme-main !default\A 2: $list-shadow: 0 2px 3px rgba($scheme-invert, 0.1), 0 0 0 1px rgba($scheme-invert, 0.1) !default\A 3: $list-radius: $radius !default\A 4: \A 5: $list-item-border: 1px solid $border !default\A 6: $list-item-color: $text !default"; }
