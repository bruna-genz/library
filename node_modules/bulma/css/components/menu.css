...
Backtrace:
C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\components\menu.sass:1
...
body:before {
  ...
  content: "Error: Undefined variable: \"$text\".\A         on line 1 of C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\components\menu.sass\A \A 1: $menu-item-color: $text !default\A 2: $menu-item-radius: $radius-small !default\A 3: $menu-item-hover-color: $text-strong !default\A 4: $menu-item-hover-background-color: $background !default\A 5: $menu-item-active-color: $link-invert !default\A 6: $menu-item-active-background-color: $link !default"; }
