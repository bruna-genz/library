...
Backtrace:
C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\components\card.sass:1
...
body:before {
  ...
  content: "Error: Undefined variable: \"$text\".\A         on line 1 of C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\components\card.sass\A \A 1: $card-color: $text !default\A 2: $card-background-color: $scheme-main !default\A 3: $card-shadow: 0 0.5em 1em -0.125em rgba($scheme-invert, 0.1), 0 0px 0 1px rgba($scheme-invert, 0.02) !default\A 4: \A 5: $card-header-background-color: transparent !default\A 6: $card-header-color: $text-strong !default"; }
