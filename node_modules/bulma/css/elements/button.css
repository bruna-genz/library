...
Backtrace:
C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\elements\button.sass:1
...
body:before {
  ...
  content: "Error: Undefined variable: \"$text-strong\".\A         on line 1 of C:\Users\User\Desktop\javascript\library\node_modules\bulma\sass\elements\button.sass\A \A 1: $button-color: $text-strong !default\A 2: $button-background-color: $scheme-main !default\A 3: $button-family: false !default\A 4: \A 5: $button-border-color: $border !default\A 6: $button-border-width: $control-border-width !default"; }
